...
func (g *generator) genMultiArguments(w io.Writer, expr *model.ObjectConsExpression, multiArgs []*schema.Property) {
	...
	hasMoreArgs := func(index int) bool {
		for _, arg := range multiArgs[index:] {
