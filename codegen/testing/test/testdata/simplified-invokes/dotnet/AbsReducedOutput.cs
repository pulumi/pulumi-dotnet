...
namespace Pulumi.Std
{
    public static class AbsReducedOutput
    {
        ...
        public static Task<double> InvokeAsync(AbsReducedOutputArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<double>("std:index:AbsReducedOutput", args ?? new AbsReducedOutputArgs(), options.WithDefaults());
        ...
        public static Output<double> Invoke(AbsReducedOutputInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<double>("std:index:AbsReducedOutput", args ?? new AbsReducedOutputInvokeArgs(), options.WithDefaults());
    }
