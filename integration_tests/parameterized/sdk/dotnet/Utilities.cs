...
namespace Pulumi.Pkg
{
    static class Utilities
    {
		...
		public static global::Pulumi.RegisterPackageRequest PackageParameterization()
		{
			return new global::Pulumi.RegisterPackageRequest(
				...
				parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
					name: "pkg",
					version: "1.0.0",
					value: global::System.Convert.FromBase64String("cGtn")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Pkg.version.txt");
    ...
    internal sealed class PkgResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PkgResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
