...
namespace Pulumi.Myext
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                version: "45.0.0",
                downloadUrl: "",
                extension: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "myext",
                    version: "2.0.0",
                    value: global::System.Convert.FromBase64String("Z3JlZXRpbmdz")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Myext.version.txt");
    ...
    internal sealed class MyextResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MyextResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
