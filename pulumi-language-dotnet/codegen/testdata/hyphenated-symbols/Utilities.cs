...
namespace Pulumi.Repro
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Repro.version.txt");
    ...
    internal sealed class ReproResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ReproResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
