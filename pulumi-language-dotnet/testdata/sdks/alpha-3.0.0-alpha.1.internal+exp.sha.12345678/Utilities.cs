...
namespace Pulumi.Alpha
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Alpha.version.txt");
    ...
    internal sealed class AlphaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AlphaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
