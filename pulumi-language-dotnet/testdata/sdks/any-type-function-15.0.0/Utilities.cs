...
namespace Pulumi.AnyTypeFunction
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AnyTypeFunction.version.txt");
    ...
    internal sealed class AnyTypeFunctionResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AnyTypeFunctionResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
