...
namespace Pulumi.Byepackage
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "byepackage",
                    version: "2.0.0",
                    value: global::System.Convert.FromBase64String("R29vZGJ5ZVdvcmxk")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Byepackage.version.txt");
    ...
    internal sealed class ByepackageResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ByepackageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
