...
namespace Pulumi.Call
{
    ...
    /// </summary>
    [CallResourceType("call:index:Custom")]
    public partial class Custom : global::Pulumi.CustomResource
    {
        ...
        public Custom(string name, CustomArgs args, CustomResourceOptions? options = null)
            : base("call:index:Custom", name, args ?? new CustomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Custom(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("call:index:Custom", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// </summary>
        public global::Pulumi.Output<CustomProviderValueResult> ProviderValue()
            => global::Pulumi.Deployment.Instance.Call<CustomProviderValueResult>("call:index:Custom/providerValue", CallArgs.Empty, this);
    }
    ...
    /// <summary>
    /// The results of the <see cref="Custom.ProviderValue"/> method.
    /// </summary>
    [OutputType]
    public sealed class CustomProviderValueResult
    {
        public readonly string Result;

        [OutputConstructor]
        private CustomProviderValueResult(string result)
        {
            Result = result;
        }
    }
