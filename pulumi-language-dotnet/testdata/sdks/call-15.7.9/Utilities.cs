...
namespace Pulumi.Call
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Call.version.txt");
    ...
    internal sealed class CallResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CallResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
