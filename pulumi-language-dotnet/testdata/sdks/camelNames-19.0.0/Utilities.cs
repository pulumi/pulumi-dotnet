...
namespace Pulumi.CamelNames
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.CamelNames.version.txt");
    ...
    internal sealed class CamelNamesResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CamelNamesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
