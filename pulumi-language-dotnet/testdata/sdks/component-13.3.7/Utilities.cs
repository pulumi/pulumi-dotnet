...
namespace Pulumi.Component
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Component.version.txt");
    ...
    internal sealed class ComponentResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ComponentResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
