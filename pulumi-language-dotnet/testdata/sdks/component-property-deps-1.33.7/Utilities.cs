...
namespace Pulumi.ComponentPropertyDeps
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ComponentPropertyDeps.version.txt");
    ...
    internal sealed class ComponentPropertyDepsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ComponentPropertyDepsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
