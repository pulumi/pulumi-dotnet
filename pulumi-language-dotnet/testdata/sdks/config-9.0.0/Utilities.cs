...
namespace Pulumi.Config_
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "http://example.com";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Config_.version.txt");
    ...
    internal sealed class Config_ResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public Config_ResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
