...
namespace Pulumi.Constant
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Constant.version.txt");
    ...
    internal sealed class ConstantResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ConstantResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
