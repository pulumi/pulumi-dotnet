...
namespace Pulumi.DiscriminatedUnion
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.DiscriminatedUnion.version.txt");
    ...
    internal sealed class DiscriminatedUnionResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DiscriminatedUnionResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
