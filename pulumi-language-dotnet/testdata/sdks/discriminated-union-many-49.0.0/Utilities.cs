...
namespace Pulumi.DiscriminatedUnionMany
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.DiscriminatedUnionMany.version.txt");
    ...
    internal sealed class DiscriminatedUnionManyResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DiscriminatedUnionManyResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
