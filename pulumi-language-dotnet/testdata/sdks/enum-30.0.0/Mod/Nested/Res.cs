...
namespace Pulumi.Enum.Mod.Nested
{
    [EnumResourceType("enum:mod/nested:Res")]
    public partial class Res : global::Pulumi.CustomResource
    {
        [Output("intEnum")]
        public Output<Pulumi.Enum.Mod.Nested.IntEnum?> IntEnum { get; private set; } = null!;

        [Output("stringEnum")]
        public Output<Pulumi.Enum.Mod.Nested.StringEnum?> StringEnum { get; private set; } = null!;
        ...
        public Res(string name, ResArgs? args = null, CustomResourceOptions? options = null)
            : base("enum:mod/nested:Res", name, args ?? new ResArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Res(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("enum:mod/nested:Res", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("intEnum")]
        public Input<Pulumi.Enum.Mod.Nested.IntEnum>? IntEnum { get; set; }

        [Input("stringEnum")]
        public Input<Pulumi.Enum.Mod.Nested.StringEnum>? StringEnum { get; set; }
