...
namespace Pulumi.Enum.Mod
{
    [EnumResourceType("enum:mod:Res")]
    public partial class Res : global::Pulumi.CustomResource
    {
        [Output("intEnum")]
        public Output<Pulumi.Enum.Mod.IntEnum?> IntEnum { get; private set; } = null!;

        [Output("stringEnum")]
        public Output<Pulumi.Enum.Mod.StringEnum?> StringEnum { get; private set; } = null!;
        ...
        public Res(string name, ResArgs? args = null, CustomResourceOptions? options = null)
            : base("enum:mod:Res", name, args ?? new ResArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Res(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("enum:mod:Res", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("intEnum")]
        public Input<Pulumi.Enum.Mod.IntEnum>? IntEnum { get; set; }

        [Input("stringEnum")]
        public Input<Pulumi.Enum.Mod.StringEnum>? StringEnum { get; set; }
