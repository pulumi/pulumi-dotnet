...
{
    [EnumResourceType("enum:index:Res")]
    public partial class Res : global::Pulumi.CustomResource
    {
        [Output("intEnum")]
        public Output<Pulumi.Enum.IntEnum?> IntEnum { get; private set; } = null!;
        ...
        public Res(string name, ResArgs? args = null, CustomResourceOptions? options = null)
            : base("enum:index:Res", name, args ?? new ResArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Res(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("enum:index:Res", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("intEnum")]
        public Input<Pulumi.Enum.IntEnum>? IntEnum { get; set; }
