...
namespace Pulumi.Enum
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Enum.version.txt");
    ...
    internal sealed class EnumResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public EnumResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
