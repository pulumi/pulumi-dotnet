...
namespace Pulumi.Extbase
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Extbase.version.txt");
    ...
    internal sealed class ExtbaseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ExtbaseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
