...
namespace Pulumi.Extenumref
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Extenumref.version.txt");
    ...
    internal sealed class ExtenumrefResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ExtenumrefResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
