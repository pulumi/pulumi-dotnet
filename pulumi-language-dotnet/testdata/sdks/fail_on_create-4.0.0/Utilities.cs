...
namespace Pulumi.Fail_on_create
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Fail_on_create.version.txt");
    ...
    internal sealed class Fail_on_createResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public Fail_on_createResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
