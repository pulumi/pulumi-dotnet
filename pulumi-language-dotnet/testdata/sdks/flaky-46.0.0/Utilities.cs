...
namespace Pulumi.Flaky
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Flaky.version.txt");
    ...
    internal sealed class FlakyResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FlakyResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
