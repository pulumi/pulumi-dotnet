...
namespace Pulumi.Goodbye
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "goodbye",
                    version: "2.0.0",
                    value: global::System.Convert.FromBase64String("R29vZGJ5ZQ==")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Goodbye.version.txt");
    ...
    internal sealed class GoodbyeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GoodbyeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
