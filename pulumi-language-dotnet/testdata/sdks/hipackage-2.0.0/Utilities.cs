...
namespace Pulumi.Hipackage
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Hipackage.version.txt");
    ...
    internal sealed class HipackageResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HipackageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
