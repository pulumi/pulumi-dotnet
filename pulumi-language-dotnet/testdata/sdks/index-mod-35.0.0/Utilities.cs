...
namespace Pulumi.IndexMod
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.IndexMod.version.txt");
    ...
    internal sealed class IndexModResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public IndexModResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
