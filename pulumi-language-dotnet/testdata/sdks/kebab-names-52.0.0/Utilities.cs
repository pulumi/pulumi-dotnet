...
namespace Pulumi.KebabNames
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.KebabNames.version.txt");
    ...
    internal sealed class KebabNamesResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KebabNamesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
