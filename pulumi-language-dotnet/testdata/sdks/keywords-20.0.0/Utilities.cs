...
namespace Pulumi.Keywords
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Keywords.version.txt");
    ...
    internal sealed class KeywordsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KeywordsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
