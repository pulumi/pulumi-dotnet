...
{
    [LargeResourceType("large:index:Map")]
    public partial class Map : global::Pulumi.CustomResource
    {
        [Output("value")]
        public Output<ImmutableDictionary<string, object>> Value { get; private set; } = null!;
        ...
        public Map(string name, MapArgs args, CustomResourceOptions? options = null)
            : base("large:index:Map", name, args ?? new MapArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Map(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("large:index:Map", name, null, MakeResourceOptions(options, id))
        {
        }
