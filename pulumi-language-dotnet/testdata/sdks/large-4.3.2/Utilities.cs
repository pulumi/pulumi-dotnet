...
namespace Pulumi.Large
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Large.version.txt");
    ...
    internal sealed class LargeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LargeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
