...
namespace Pulumi.ModuleFormat
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ModuleFormat.version.txt");
    ...
    internal sealed class ModuleFormatResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ModuleFormatResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
