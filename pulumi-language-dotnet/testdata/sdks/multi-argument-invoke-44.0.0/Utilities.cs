...
namespace Pulumi.MultiArgumentInvoke
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.MultiArgumentInvoke.version.txt");
    ...
    internal sealed class MultiArgumentInvokeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MultiArgumentInvokeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
