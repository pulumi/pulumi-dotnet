...
namespace Pulumi.Names.Mod.Nested
{
    [NamesResourceType("names:mod/nested:Res")]
    public partial class Res : global::Pulumi.CustomResource
    {
        ...
        public Res(string name, ResArgs args, CustomResourceOptions? options = null)
            : base("names:mod/nested:Res", name, args ?? new ResArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Res(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("names:mod/nested:Res", name, null, MakeResourceOptions(options, id))
        {
        }
