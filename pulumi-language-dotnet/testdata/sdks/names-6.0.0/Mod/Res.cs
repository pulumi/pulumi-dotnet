...
namespace Pulumi.Names.Mod
{
    [NamesResourceType("names:mod:Res")]
    public partial class Res : global::Pulumi.CustomResource
    {
        ...
        public Res(string name, ResArgs args, CustomResourceOptions? options = null)
            : base("names:mod:Res", name, args ?? new ResArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Res(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("names:mod:Res", name, null, MakeResourceOptions(options, id))
        {
        }
