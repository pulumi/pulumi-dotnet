...
namespace Pulumi.Names
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Names.version.txt");
    ...
    internal sealed class NamesResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NamesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
