...
namespace ANamespace.Namespaced
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("ANamespace.Namespaced.version.txt");
    ...
    internal sealed class NamespacedResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NamespacedResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
