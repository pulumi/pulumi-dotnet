...
namespace Pulumi.Nestedobject
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Nestedobject.version.txt");
    ...
    internal sealed class NestedobjectResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NestedobjectResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
