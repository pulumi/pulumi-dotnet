...
namespace Pulumi.Output
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Output.version.txt");
    ...
    internal sealed class OutputResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OutputResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
