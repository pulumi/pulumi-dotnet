...
namespace Pulumi.OutputOnlyInvoke
{
    public static class SecretInvoke
    {
        public static Task<SecretInvokeResult> InvokeAsync(SecretInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<SecretInvokeResult>("output-only-invoke:index:secretInvoke", args ?? new SecretInvokeArgs(), options.WithDefaults());

        public static Output<SecretInvokeResult> Invoke(SecretInvokeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<SecretInvokeResult>("output-only-invoke:index:secretInvoke", args ?? new SecretInvokeInvokeArgs(), options.WithDefaults());
