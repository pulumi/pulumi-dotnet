...
namespace Pulumi.OutputOnlyInvoke
{
    public static class Unit
    {
        public static Task<UnitResult> InvokeAsync(UnitArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<UnitResult>("output-only-invoke:index:unit", args ?? new UnitArgs(), options.WithDefaults());

        public static Output<UnitResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<UnitResult>("output-only-invoke:index:unit", InvokeArgs.Empty, options.WithDefaults());
