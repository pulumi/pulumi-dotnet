...
namespace Pulumi.OutputOnlyInvoke
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.OutputOnlyInvoke.version.txt");
    ...
    internal sealed class OutputOnlyInvokeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OutputOnlyInvokeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
