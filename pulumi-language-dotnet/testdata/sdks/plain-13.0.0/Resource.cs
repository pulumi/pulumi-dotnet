...
namespace Pulumi.Plain
{
    [PlainResourceType("plain:index:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("nonPlainData")]
        public Output<Outputs.Data?> NonPlainData { get; private set; } = null!;
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("plain:index:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("plain:index:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("nonPlainData")]
        public Input<Inputs.DataArgs>? NonPlainData { get; set; }
