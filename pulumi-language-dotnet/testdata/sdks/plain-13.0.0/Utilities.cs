...
namespace Pulumi.Plain
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Plain.version.txt");
    ...
    internal sealed class PlainResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PlainResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
