...
{
    [PlaincomponentResourceType("plaincomponent:index:Custom")]
    public partial class Custom : global::Pulumi.CustomResource
    {
        ...
        public Custom(string name, CustomArgs args, CustomResourceOptions? options = null)
            : base("plaincomponent:index:Custom", name, args ?? new CustomArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Custom(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("plaincomponent:index:Custom", name, null, MakeResourceOptions(options, id))
        {
        }
