...
namespace Pulumi.Plaincomponent
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Plaincomponent.version.txt");
    ...
    internal sealed class PlaincomponentResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PlaincomponentResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
