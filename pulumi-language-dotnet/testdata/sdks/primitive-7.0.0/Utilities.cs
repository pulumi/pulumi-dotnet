...
namespace Pulumi.Primitive
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Primitive.version.txt");
    ...
    internal sealed class PrimitiveResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PrimitiveResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
