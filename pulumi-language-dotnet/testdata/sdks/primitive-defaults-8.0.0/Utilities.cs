...
namespace Pulumi.PrimitiveDefaults
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.PrimitiveDefaults.version.txt");
    ...
    internal sealed class PrimitiveDefaultsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PrimitiveDefaultsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
