...
namespace Pulumi.PrimitiveRef
{
    [PrimitiveRefResourceType("primitive-ref:index:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("primitive-ref:index:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("primitive-ref:index:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DataArgs> Data { get; set; } = null!;
