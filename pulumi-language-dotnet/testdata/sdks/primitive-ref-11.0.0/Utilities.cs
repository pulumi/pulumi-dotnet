...
namespace Pulumi.PrimitiveRef
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.PrimitiveRef.version.txt");
    ...
    internal sealed class PrimitiveRefResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PrimitiveRefResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
