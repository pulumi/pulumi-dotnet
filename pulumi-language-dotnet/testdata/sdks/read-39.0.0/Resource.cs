...
namespace Pulumi.Read
{
    [ReadResourceType("read:index:Resource")]
    public partial class Resource : global::Pulumi.CustomResource
    {
        [Output("lookup")]
        public Output<string> Lookup { get; private set; } = null!;
        ...
        public Resource(string name, ResourceArgs args, CustomResourceOptions? options = null)
            : base("read:index:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, ResourceState? state = null, CustomResourceOptions? options = null)
            : base("read:index:Resource", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("lookup", required: true)]
        public Input<string> Lookup { get; set; } = null!;
