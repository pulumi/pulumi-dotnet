...
namespace Pulumi.Read
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Read.version.txt");
    ...
    internal sealed class ReadResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ReadResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
