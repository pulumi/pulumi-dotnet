...
namespace Pulumi.RefRef
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.RefRef.version.txt");
    ...
    internal sealed class RefRefResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RefRefResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
