...
namespace Pulumi.Replaceonchanges
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Replaceonchanges.version.txt");
    ...
    internal sealed class ReplaceonchangesResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ReplaceonchangesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
