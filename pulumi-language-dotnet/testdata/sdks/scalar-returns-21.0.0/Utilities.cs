...
namespace Pulumi.ScalarReturns
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ScalarReturns.version.txt");
    ...
    internal sealed class ScalarReturnsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ScalarReturnsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
