...
namespace Pulumi.Simple
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/pulumi/pulumi-simple/releases/v${VERSION}";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Simple.version.txt");
    ...
    internal sealed class SimpleResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SimpleResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
