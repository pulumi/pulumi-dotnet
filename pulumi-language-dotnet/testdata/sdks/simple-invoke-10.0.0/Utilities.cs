...
namespace Pulumi.SimpleInvoke
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.SimpleInvoke.version.txt");
    ...
    internal sealed class SimpleInvokeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SimpleInvokeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
