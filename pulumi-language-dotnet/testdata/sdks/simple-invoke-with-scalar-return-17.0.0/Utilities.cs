...
namespace Pulumi.SimpleInvokeWithScalarReturn
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.SimpleInvokeWithScalarReturn.version.txt");
    ...
    internal sealed class SimpleInvokeWithScalarReturnResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SimpleInvokeWithScalarReturnResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
