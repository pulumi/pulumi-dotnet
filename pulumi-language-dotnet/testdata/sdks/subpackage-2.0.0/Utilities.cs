...
namespace Pulumi.Subpackage
{
    static class Utilities
    {
        ...
        public static global::Pulumi.RegisterPackageRequest PackageParameterization()
        {
            return new global::Pulumi.RegisterPackageRequest(
                ...
                parameterization: new global::Pulumi.RegisterPackageRequest.PackageParameterization(
                    name: "subpackage",
                    version: "2.0.0",
                    value: global::System.Convert.FromBase64String("SGVsbG9Xb3JsZA==")));
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Subpackage.version.txt");
    ...
    internal sealed class SubpackageResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SubpackageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
