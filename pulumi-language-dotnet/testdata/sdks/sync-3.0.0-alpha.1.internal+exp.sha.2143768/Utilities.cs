...
namespace Pulumi.Sync
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sync.version.txt");
    ...
    internal sealed class SyncResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SyncResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
