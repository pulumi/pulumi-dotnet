...
public abstract class ProviderServerTestHost : IAsyncLifetime
{
    ...
    protected abstract Experimental.Provider.Provider BuildProvider(Experimental.Provider.IEngine runner);
...
{
    protected override Experimental.Provider.Provider BuildProvider(Experimental.Provider.IEngine runner)
    {
