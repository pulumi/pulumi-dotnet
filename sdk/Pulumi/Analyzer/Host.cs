...
namespace Pulumi.Analyzer
{
    ...
    public sealed class LogMessage
    {
        ...
        public LogMessage(LogSeverity severity, string message, Urn? urn = null, int streamId = 0,
    ...
    internal class GrpcHost : IHost
    {
        ...
        private static readonly ConcurrentDictionary<string, GrpcChannel> _engineChannels =
