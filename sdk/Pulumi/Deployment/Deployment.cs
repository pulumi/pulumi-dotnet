...
namespace Pulumi
{
    ...
    public sealed partial class Deployment : IDeploymentInternal
    {
        ...
        private Deployment(IDeploymentBuilder deploymentBuilder, RunnerOptions? runnerOptions = null)
        {
